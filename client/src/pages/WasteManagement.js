  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 28 }}>
        ...
        <h1 style={{ fontSize: 'clamp(22px, 4vw, 26px)', fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 8px' }}>Waste Management</h1>
        <p style={{ color: 'var(--text-secondary)', fontSize: 13 }}>Track waste avoided and see your environmental impact!</p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(10,40,24,0.85)', fontSize: 14, margin: 0 }}>Total CO₂ Saved</p>
        </div>
      </div>

      <div className="dark-card" style={{ padding: 20, marginBottom: 20 }}>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 14px' }}>Add Waste Entry</h3>
      ...
      <div className="dark-card" style={{ padding: '20px' }}>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 16px' }}>Waste Reduction Tips</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
          ...
          <div>
            <h4 style={{ fontWeight: 700, color: 'var(--text-primary)', margin: '0 0 10px', fontSize: 14 }}>Organic Waste</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 8 }}>
